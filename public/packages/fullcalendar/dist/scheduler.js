 ...
 */
!function (e, t) {
    if ("object" == typeof exports && "object" == typeof module) module.exports = t(require("fullcalendar"), require("jquery"), require("moment")); else if ("function" == typeof define && define.amd) define(["fullcalendar", "jquery", "moment"], t); else {
    ...
    return function (e) {
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(1), n = r(2), i = r(0), s = function (e) {
            function t() {
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(1), n = r(2), i = r(0), s = r(21), a = r(6), l = function (e) {
            function t(t) {
            ...
            return o.__extends(t, e), t.prototype.renderDates = function (e) {
                ...
                for (var t = this.resourceCnt, r = this.datesAboveResources ? this.sliceRangeByDay(e.unzonedRange) : this.sliceRangeByRow(e.unzonedRange), o = [], i = 0, s = r; i < s.length; i++) for (var l = s[i], c = 0; c < t; c++) {
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(1), n = r(2), i = r(15), s = r(0), a = r(24), l = r(25), c = r(16), u = r(26), d = r(17), h = r(28),
            p = r(29), f = r(40), v = r(41), g = r(42), y = function (e) {
                function t(t, r) {
                ...
                return o.__extends(t, e), t.prototype.normalizeComponentFootprint = function (e) {
                    ...
                    if (this.isTimeScale) r = this.normalizeGridDate(o.getStart()), t = this.normalizeGridDate(o.getEnd()); else {
                    ...
                    var t = e.unzonedRange.getStart(), r = e.unzonedRange.getEnd(), o = this.normalizeComponentFootprint(e),
                        n = [];
                    ...
                    var t = [], r = this.normalizedUnzonedStart.clone();
                    ...
                    for (var e, t, r, o, n = this.calendar.theme, i = this.labelInterval, a = this.headerFormats, l = a.map(function (e) {
                        ...
                        for (var g = t.week(), y = this.emphasizeWeeks && null !== u && u !== g, m = 0; m < a.length; m++) {
                            ...
                            var R = a.length > 1 && m < a.length - 1, w = null;
                            if (R) {
                                var b = t.format(o);
                    ...
                    var S = i > this.slotDuration, E = 1 === this.slotDuration.as("days"),
                    ...
                    var o = this.buildGotoAnchorHtml({
                        ...
                        type: r,
                        forceOff: !r
                    }, {"class": "fc-cell-text"}, s.htmlEscape(t));
                    ...
                    if (e = this.normalizeGridDate(e), this.normalizedUnzonedRange.containsDate(e)) {
                        var r = this.dateToCoord(e), o = this.isRTL ? {right: -r} : {left: r};
                    ...
                    var e = 0, t = this.timeHeadEl.find("tr:last-child th .fc-cell-text");
                    t.each(function (t, r) {
                        var o = n(r).outerWidth();
                        return e = Math.max(e, o)
                    });
                    var r = e + 1, o = s.divideDurationByDuration(this.labelInterval, this.slotDuration),
                        i = Math.ceil(r / o), a = this.timeHeadColEls.eq(0).css("min-width");
                    ...
                    var r = Math.floor(t), o = this.snapDiffToIndex[r];
                    return s.isInt(o) ? o += t - r : o = Math.ceil(o), o
                }, t.prototype.dateToCoord = function (e) {
                    var t = this.computeDateSnapCoverage(e), r = t / this.snapsPerSlot, o = Math.floor(r);
                    o = Math.min(o, this.slotCnt - 1);
                    var n = r - o, i = this.slatInnerCoordCache;
                    ...
                    for (var e = [].concat(this.getEventSegs(), this.getBusinessHourSegs()), t = 0, r = e; t < r.length; t++) {
                        var o = r[t], n = this.rangeToCoords(o);
                    ...
                    var e = this.get("dateProfile").activeUnzonedRange, t = 0;
                    if (this.isTimeScale) {
                    ...
                    var r = this.snapsPerSlot, o = this.slatCoordCache, n = this.timeBodyBoundCache;
                    if (n.isPointInBounds(e, t)) {
                        var i = o.getHorizontalIndex(e);
                        if (null != i) {
                            var s = void 0, a = void 0, l = void 0, c = void 0, u = void 0, d = o.getWidth(i);
                            if (this.isRTL) {
        ...
        var r = function () {
            ...
            return e.prototype.initScroller = function (e) {
                ...
                e.scrollEl.on("wheel mousewheel DomMouseScroll MozMousePixelScroll", function () {
                    ...
                    if (e === t.masterScroller) for (var r = 0, o = t.scrollers; r < o.length; r++) {
                        var n = o[r];
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var s = r(1), a = r(0), l = r(27), c = function (e) {
            function t() {
                return null !== e && e.apply(this, arguments) || this
            }
            ...
            return s.__extends(t, e), t.prototype.computeDisplayEventTime = function () {
                ...
                for (var t = this.view.eventTitleFollower, r = 0, n = e; r < n.length; r++) {
                    var i = n[r], s = this.component.rangeToCoords(i);
                ...
                for (var f = 0, v = e; f < v.length; f++) {
                    var i = v[f], g = i.el.find(".fc-title");
                ...
                var r = e.footprint.eventDef, o = this.view.isEventDefDraggable(r),
                    n = e.isStart && this.view.isEventDefResizableFromStart(r),
                    i = e.isEnd && this.view.isEventDefResizableFromEnd(r), s = this.getSegClasses(e, o, n || i);
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(1), n = r(2), i = r(0), s = r(44), a = function (e) {
            function t(t) {
                var r = e.call(this, t) || this;
            ...
            return o.__extends(t, e), t.prototype.addChildRowNode = function (e, t) {
                ...
                if (this.hasOwnRow) {
                    ...
                    for (var r in this.view.tbodyHash) {
                        var o = this.view.tbodyHash[r], s = n("<tr/>");
                ...
                if (this.set("isInDom", !0), this.isExpanded) for (var l = 0, c = this.children; l < c.length; l++) {
                    var u = c[l];
                    u.renderSkeleton()
                }
            }, t.prototype.removeElement = function () {
                for (var e in this.trHash) {
                    var t = this.trHash[e], r = "unrender" + i.capitaliseFirstLetter(e) + "Skeleton";
                    this[r] && this[r](t)
                }
                ...
                var e = this.children[0], t = e && e.getLeadingRow(), r = t && t.trs;
        ...
        var r = function () {
            ...
            return e.extractIds = function (t, r) {
                var o = r.opt("eventResourceField") || "resourceId", n = [];
                if (t.resourceIds) for (var i = 0, s = t.resourceIds; i < s.length; i++) {
                    var a = s[i];
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(1), n = r(0), i = r(9), s = r(13), a = r(38), l = function (e) {
            function t(t, r) {
                var o = e.call(this, t, r) || this;
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(1), n = r(2), i = r(0), s = r(6), a = function (e) {
            function t() {
                return null !== e && e.apply(this, arguments) || this
            }
            ...
            return o.__extends(t, e), t.mixInto = function (e) {
                ...
                var e = this, t = this.flattenedResources.map(function (t) {
                ...
                for (var t = [], r = this.colCnt, o = 0; o < r; o++) {
                    var n = this.getCellDate(e, o), i = this.getColResource(o);
                ...
                for (var t = this.hasAllDayBusinessHours, r = this.dateProfile.activeUnzonedRange, o = [], n = 0, a = this.flattenedResources; n < a.length; n++) {
                    var l = a[n], c = (l.businessHourGenerator || e).buildEventInstanceGroup(t, r);
                    if (c) for (var u = 0, d = c.sliceRenderRanges(r); u < d.length; u++) {
                        var h = d[u];
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(1), n = r(0), i = r(9), s = r(13), a = function (e) {
            function t(t, r) {
                var o = e.call(this, t, r) || this;
                return o.initResourceView(), o
            }
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(1), n = r(2), i = r(0), s = r(39), a = function (e) {
            function t(t) {
                var r = e.call(this, t) || this;
            ...
            return o.__extends(t, e), t.prototype.renderEl = function () {
                ...
                var e = this.scrollEl, t = i.getScrollbarWidths(e),
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(2), n = r(0), i = r(27), s = function () {
            function e(e, t) {
                void 0 === t && (t = !1);
                var r = this;
            ...
            return e.prototype.setSpriteEls = function (e) {
                ...
                var e = this.scroller, t = e.getScrollFromLeft(), r = e.getScrollTop();
        ...
        var h = r(0), p = function () {
            ...
            return e.prototype.disable = function () {
                ...
                var o = this.follower, s = this.naturalRect = o.getBoundingRect(this.el), a = this.el.parent();
                this.parentRect = o.getBoundingRect(a);
                var l = this.containerRect = d(o.getContentRect(a), s), c = o.minTravel;
                ...
                var e = this.follower.viewportRect, t = this.parentRect, r = this.containerRect,
                    i = h.intersectRects(e, t), a = null, l = !1;
                if (i) {
                ...
                if (this.isEnabled) if (this.rect) if (this.doAbsolute && !this.follower.isForcedRelative) this.absolutize(), this.absoluteEl.css({
                    ...
                    var e = this.rect.top - this.naturalRect.top, t = this.rect.left - this.naturalRect.left;
            ...
            return o.__extends(t, e), t.prototype.attachSegEls = function (e, t) {
                if (t.length) {
                    ...
                    for (var o = n('<div class="fc-' + r + '-container" />').appendTo(this.component.bgSegContainerEl), i = 0, s = t; i < s.length; i++) {
                        var a = s[i], l = this.component.rangeToCoords(a);
        ...
        var o = r(1), n = r(2), i = r(0), s = function (e) {
            ...
            return o.__extends(t, e), t.prototype.renderSegs = function (e, t) {
                for (var r = [], o = 0, i = e; o < i.length; o++) {
                    var s = i[o], a = this.component.rangeToCoords(s);
                    s.el.css({
                        left: s.left = a.left,
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var i = r(1), s = r(2), a = r(0), l = r(16), c = r(6), u = r(9), d = r(14), h = r(43), p = r(45), f = r(18),
            v = r(46), g = r(47), y = r(31), m = r(33), R = function (e) {
                function t(t, r) {
                    var o = e.call(this, t, r) || this;
                ...
                return i.__extends(t, e), t.prototype.processResourceOptions = function () {
                    var e = this.opt("resourceColumns") || [], t = this.opt("resourceLabelText"), r = "Resources", o = null;
                    ...
                    if (n[0].isMain = !0, i.length) s = i, l = !0; else {
                    ...
                    var e = this, t = this.opt("resourceAreaWidth");
                    ...
                    var t = this, r = this.opt("isRTL"), o = 30, n = this.el.width() - 30,
                        i = this.getNaturalDividerWidth(), s = new a.DragListener({
                            dragStart: function () {
                    ...
                    for (var e = {}, t = this.timeBodyScroller.scrollEl.offset().top, r = 0, o = this.getVisibleRows(); r < o.length; r++) {
                        var n = o[r];
                        if (n.resource) {
                            var i = n.getTr("event"), s = i.offset().top + i.outerHeight();
                            if (s > t) {
                    ...
                    if (e.resourceId) {
                        ...
                        if (t) {
                            var r = t.getTr("event");
                            if (r) {
                                var o = this.timeBodyScroller.canvas.el.offset().top, n = r.offset().top + r.outerHeight(),
                                    i = n - e.bottom - o;
                    ...
                    if (t) {
                        var r = t.getTr("event");
                        if (r) {
                            var o = this.timeBodyScroller.canvas.el.offset().top, n = r.offset().top - o;
                    ...
                    var t, r = {}, o = {};
                    for (var n in e) {
                        var i = e[n], s = i.getEventDef(), a = s.getResourceIds();
                        if (a.length) for (var l = 0, c = a; l < c.length; l++) {
                            t = c[l];
                            var u = r[t] || (r[t] = {});
                            u[n] = i
                    ...
                    for (t in r) {
                        var d = r[t], h = this.getResourceRow(t);
                    ...
                    var r = !t, o = new v["default"](this, e);
                    ...
                    if (this.orderSpecs.length) for (var r = 0; r < t.children.length; r++) {
                        var o = t.children[r], n = this.compareResources(o.resource || {}, e.resource || {});
                        if (n > 0) return r
                    }
                    return null
                    ...
                    var o, n, i = (e.resource || {})[r.field], s = null;
                    if (r.order) for (o = 0; o < t.children.length; o++) {
                        n = t.children[o];
                        ...
                        if (l > 0) break
                    } else for (o = 0; o < t.children.length; o++) if (n = t.children[o], n.groupValue === i) {
                        s = n;
                        break
                    }
                    return s || (s = this.isVGrouping ? new y["default"](this, r, i) : new g["default"](this, r, i), t.addChildRowNode(s, o), s.renderSkeleton()), s
                }, t.prototype.descendantAdded = function (e) {
                    var t = this.isNesting, r = Boolean(this.nestingCnt += e.depth ? 1 : 0);
                    ...
                    if (!t) {
                        var a = this.spreadsheet.tbodyEl.height(), l = this.timeBodyTbodyEl.height();
                    ...
                    var n = o(e);
                    for (var i in n) {
                        var s = n[i], a = this.getResourceRow(i);
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(1), n = r(2), i = r(32), s = function (e) {
            function t(t, r, o) {
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(1), n = r(2), i = r(18), s = function (e) {
            function t(t, r, o) {
            ...
            return o.__extends(t, e), t.prototype.descendantRemoved = function (t) {
                ...
                var e = this.groupValue || "", t = this.groupSpec.text;
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(1), n = r(0), i = r(18), s = r(28), a = r(17), l = r(29), c = function (e) {
            function t() {
                return null !== e && e.apply(this, arguments) || this
            }
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(0), n = r(20), i = r(22), s = r(23), a = r(14), l = r(30);
        ...
        var o = r(1), n = r(2), i = r(0), s = r(21), a = r(6), l = function (e) {
            ...
            return o.__extends(t, e), t.prototype.renderDates = function (e) {
                ...
                for (var t = this.resourceCnt, r = this.sliceRangeByTimes(e.unzonedRange), o = [], i = 0, s = r; i < s.length; i++) for (var l = s[i], c = 0; c < t; c++) {
                    var u = this.flattenedResources[c];
                    if (!(e instanceof a["default"]) || e.resourceId === u.id) {
                        var d = n.extend({}, l);
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var n = r(1), i = r(2), s = r(0), a = null, l = function (e) {
            function t(t) {
                var r = e.call(this, t) || this;
            ...
            return n.__extends(t, e), t.prototype.render = function () {
                ...
                var e = this.scrollEl.css("direction"), t = this.scrollEl[0], r = t.scrollLeft;
                if ("rtl" === e) switch (a) {
                    case"positive":
                ...
                var t = this.scrollEl.css("direction"), r = this.scrollEl[0];
                if ("rtl" === t) switch (a) {
                    case"positive":
        ...
        function o(e) {
            ...
            var t = e.opt("slotLabelFormat"), r = c.type(t);
        ...
        function s(e) {
            var t = e.dateProfile.currentUnzonedRange, r = e.labelInterval;
            if (!r) {
                var o = void 0;
                if (e.slotDuration) {
                    for (var n = 0, i = v; n < i.length; n++) {
                        o = i[n];
                        var s = u.duration(o), a = d.divideDurationByDuration(s, e.slotDuration);
                        if (d.isInt(a) && a <= p) {
                            r = s;
                            break
                        }
                    ...
                    r || (r = e.slotDuration)
                } else for (var l = 0, c = v; l < c.length; l++) {
        ...
        function a(e) {
            var t = e.dateProfile.currentUnzonedRange, r = e.slotDuration;
            if (!r) {
                for (var o = s(e), n = 0, i = v; n < i.length; n++) {
                    var a = i[n], l = u.duration(a), c = d.divideDurationByDuration(o, l);
        ...
        function l(e) {
            var t, r, o = e.labelInterval, n = d.computeGreatestUnit(o), i = e.opt("weekNumbers"), s = t = r = null;
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var c = r(2), u = r(15), d = r(0), h = 18, p = 6, f = 200;
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(2), n = r(0), i = r(24), s = r(25), a = r(16), l = r(26), c = r(31), u = 30, d = function () {
            function e(e) {
            ...
            return e.prototype.renderSkeleton = function () {
                ...
                var o = this, i = this.colWidths = this.queryColWidths();
                i.pop(), i.push(null);
                var s = i[e], a = Math.min(this.colMinWidths[e], u), l = new n.DragListener({
                    dragStart: function () {
                ...
                var u = s && !this.view.isHGrouping ? "auto" : "", d = n.map(function (e) {
                    return null != e ? e : u
                }), h = 0;
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(1), n = r(17), i = function (e) {
            function t() {
                return null !== e && e.apply(this, arguments) || this
            }

            return o.__extends(t, e), t.prototype.renderFgRanges = function (e) {
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(1), n = r(2), i = r(0), s = r(33), a = function (e) {
            function t(t, r) {
            ...
            return o.__extends(t, e), t.prototype.renderSkeleton = function () {
                ...
                for (var t = this.view.calendar.theme, r = this.resource, o = 0, s = this.view.colSpecs; o < s.length; o++) {
                    var a = s[o];
                    if (!a.group) {
                        var l = a.field ? r[a.field] || null : r, c = "function" == typeof a.text ? a.text(r, l) : l,
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(2), n = r(0), i = r(19), s = r(49), a = r(6), l = {
        ...
        n.Calendar.defaults.refetchResourcesOnNavigate = !1, n.Calendar.defaults.filterResourcesWithEvents = !1, n.Calendar.prototype.resourceManager = null, n.Calendar.prototype.constructed = function () {
            ...
            var t = this.viewSpecManager.getViewSpec(e), r = t["class"];
            ...
            var t = this, r = "object" == typeof e ? e : this.getResourceById(e);
            ...
            var t = "object" == typeof e ? e : this.clientEvents(e)[0], r = [];
            if (t) for (var o = 0, n = this.getEventResourceIds(t); o < n.length; o++) {
                var i = n[o], s = this.getResourceById(i);
                s && r.push(s)
            }
            return r
        }
        ...
        var o = r(1), n = r(2), i = r(0), s = function (e) {
            ...
            return o.__extends(t, e), t.prototype.getResources = function (e, t) {
                ...
                var i = this, s = this.calendar, a = s.opt("resources"), l = s.opt("timezone");
                switch ("string" === n.type(a) && (a = {url: a}), n.type(a)) {
                    ...
                    case"object":
                        s.pushLoading();
                        var c = {};
                        r && o && (c[s.opt("startParam")] = r.format(), c[s.opt("endParam")] = o.format(), l && "local" !== l && (c[s.opt("timezoneParam")] = l)), n.ajax(n.extend({data: c}, t.ajaxDefaults, a)).then(function (t) {
                            s.popLoading(), e(t)
                        });
                        break;
                    case"array":
                ...
                var t, r = this, o = Boolean(this.topLevelResources);
                ...
                if (!e.parent) {
                    var t = void 0, r = String(null != e.parentId ? e.parentId : "");
                    if (r) {
                ...
                var t = this, r = "object" == typeof e ? e.id : e;
                return this.fetching ? this.fetching.then(function () {
                ...
                var r = this, o = n.extend({}, e), s = e.eventClassName;
            ...
            }, t.resourceGuid = 1, t.ajaxDefaults = {dataType: "json", cache: !1}, t
        }(i.Class);
        t["default"] = s, i.EmitterMixin.mixInto(s)
    }, function (e, t, r) {
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(2), n = r(0), i = r(19), s = r(6), a = {
        ...
        n.Constraints.prototype.getPeerEventInstances = function (e) {
            var t = e.getResourceIds(), r = a.getPeerEventInstances.apply(this, arguments);
            ...
            if (r) {
                for (var l = this._calendar.view, c = l.get("businessHourGenerator"), u = l.dateProfile.activeUnzonedRange, d = [], h = 0, p = t; h < p.length; h++) {
                    var i = p[h], f = i.businessHourGenerator || c, v = f.buildEventInstanceGroup(e, u);
                    if (v) for (var g = 0, y = v.getAllEventRanges(); g < y.length; g++) {
                        var m = y[g];
            ...
            var t = e.eventDef, r = t.getResourceIds();
            ...
            var t = a.parseFootprints.apply(this, arguments), r = e.resourceIds || [];
            if (e.resourceId && (r = [e.resourceId].concat(r)), r.length) {
                for (var o = [], n = 0, i = r; n < i.length; n++) for (var l = i[n], c = 0, u = t; c < u.length; c++) {
                    var d = u[c];
        ...
        n.View.prototype.canHandleSpecificResources = !1, n.View.prototype.setElement = function () {
            ...
            var e = this, t = [], r = ["initialResources"];
            ...
            for (var r = this.eventsPayloadToRanges(t), n = {}, i = 0, s = r; i < s.length; i++) for (var a = s[i], l = 0, c = a.eventDef.getResourceIds(); l < c.length; l++) {
                var u = c[l];
                n[u] = !0
            }
            return o(e, n)
        }, n.View.prototype.eventsPayloadToRanges = function (e) {
            var t = this._getDateProfile(), r = [];
            for (var o in e) {
                var n = e[o], i = n.sliceRenderRanges(t.activeUnzonedRange);
                r.push.apply(r, i || [])
            }
            return r
        }
        ...
        function n(e) {
            ...
            if (t && 10 === t[1].length) {
                var r = c.utc(1e3 * parseInt(t[2], 10)), o = c.utc(u.mockSchedulerReleaseDate || d);
                if (o.isValid()) {
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var l = r(2), c = r(15), u = r(0), d = "2018-03-27", h = {years: 1, weeks: 1},
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(0), n = {isEventDefDraggable: o.InteractiveDateComponent.prototype.isEventDefDraggable};
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var n = r(0), i = {getFallbackStylingObjs: n.EventRenderer.prototype.getFallbackStylingObjs};
        n.EventRenderer.prototype.designatedResource = null, n.EventRenderer.prototype.currentResource = null, n.EventRenderer.prototype.beforeFgSegHtml = function (e) {
            ...
            if (this.currentResource) t.unshift(this.currentResource); else {
                for (var r = [], n = 0, s = e.getResourceIds(); n < s.length; n++) {
                    var a = s[n], l = o(this, a);
                    l && r.push(l)
                }
                t = r.concat(t)
            }
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(0), n = r(6), i = {computeSelectionFootprint: o.DateSelecting.prototype.computeSelectionFootprint};
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(0), n = {computeEventDropMutation: o.EventDragging.prototype.computeEventDropMutation};
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(0), n = {computeExternalDrop: o.ExternalDropping.prototype.computeExternalDrop};
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(2), n = r(0), i = r(19), s = {
            applyMiscProps: n.EventDef.prototype.applyMiscProps,
            clone: n.EventDef.prototype.clone,
            toLegacy: n.EventDef.prototype.toLegacy
        };
        n.EventDef.defineStandardProps({resourceEditable: !0}), n.EventDef.prototype.resourceIds = null, n.EventDef.prototype.resourceEditable = null, n.EventDef.prototype.applyMiscProps = function (e) {
            ...
            var e = s.toLegacy.apply(this, arguments), t = this.getResourceIds();
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(0), n = o.EventDefMutation.prototype.mutateSingle;
        o.EventDefMutation.prototype.oldResourceId = null, o.EventDefMutation.prototype.newResourceId = null, o.EventDefMutation.prototype.mutateSingle = function (e) {
            var t = n.apply(this, arguments), r = null;
            return this.oldResourceId && e.hasResourceId(this.oldResourceId) && (r = e.getResourceIds(), e.removeResourceId(this.oldResourceId), e.addResourceId(this.newResourceId)), function () {
                t(), r && (e.resourceIds = r)
            }
        }
    }, function (e, t, r) {
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = r(0), n = r(22), i = r(23);
        o.getViewConfig("basic").queryResourceClass = function (e) {
            var t = e.options.groupByResource || e.options.groupByDateAndResource, r = !1;
